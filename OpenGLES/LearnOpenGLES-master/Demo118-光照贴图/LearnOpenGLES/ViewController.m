...
- (void)viewDidLoad {
    ...
    glEnableVertexAttribArray(GLKVertexAttribNormal); //纹理
    ...
    self.mEffect.material.diffuseColor = GLKVector4Make(0.8, 0.1, 0.1 , 1.0f);
    self.mEffect.material.specularColor = GLKVector4Make(0.1, 0.1, 0.1 , 1.0f);
    self.mEffect.colorMaterialEnabled = GL_TRUE;
}
